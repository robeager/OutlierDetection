#This encoder takes in scalar data and represents it as a randomly distributed pattern
...
#clear buckets and bits
n = NULL
w = NULL
res = NULL
buckets = NULL

#reset buckets and bits

w = 21
n = 400 # make > 11*(w+1)
res = max(0.001,((maxChange-minChange)/n))

set.seed(sample(rbinom(1000,100,0.4),1))
